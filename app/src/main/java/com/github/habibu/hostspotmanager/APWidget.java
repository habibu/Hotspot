...
public class APWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < appWidgetIds.length; i++) {
            ...
            rv.setImageViewResource(R.id.widgetButton, toggleButton());
            ...
            rv.setOnClickPendingIntent(R.id.widgetButton, pi);
            //Intent tetherSettings = new Intent();
            //tetherSettings.setClassName(context, "com.android.settings.TetherSettings");
            rv.setOnClickPendingIntent(R.id.widgetLinearLayout, tphs(context));
    ...
    private int toggleButton() {
        return state ? R.drawable.ic_on_wifi_tethering_black_24dp : R.drawable.ic_wifi_off_black_24dp;
    }
